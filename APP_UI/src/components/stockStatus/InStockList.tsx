...
const InStockList: React.FC<outOfStockListProps> = ({ imprestId }: any) => {
    ...
    const fetchAvailableStock = async () => {
        try {
            ...
            const availableStockList = filteredProducts.filter((product: any) => product.available_stock > product.min_stock);
            setAvailableStock(availableStockList);
            setLoading(false);
        } catch (error) {
                ...
                loading ? (
                    ...
                    <div className="" style={{ padding: "15px" }}>
                        <MitteDataTable
                            ...
                            totalRows={availableStock?.length}
